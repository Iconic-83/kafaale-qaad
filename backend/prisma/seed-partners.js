...
const prisma = new PrismaClient({
  datasources: { db: { url: 'postgresql://postgres:postgres@localhost:5433/kafaale_db' } }
});
...
async function main() {
  console.log('🌱 Seeding Impact Partners into live PostgreSQL…\n');
  ...
  console.log(`\n✅ ${PARTNERS.length} partners live in the database!`);
}
